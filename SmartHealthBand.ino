...
void loop() {
  ...
  temperature(irValue) ;
  heartbeatsense(irValue)  ;                               

  
}


void heartbeatsense(long irValue)
{
  ...
  if (irValue < 7000){       //If no finger is detected it inform the user and put the average BPM to 0 or it will be stored for the next measure
     ...
     display.println("your finger "); 
      display.setCursor(10, 20); /*Display static text*/
      display.print("Temp=");
      display.print(mlx.readObjectTempC());  /*String to represent on OLED display*/
      display.print("*C"); 
     display.display();
